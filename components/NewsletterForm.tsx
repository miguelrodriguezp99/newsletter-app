...
function NewsletterForm() {
    ...
    const handleSubmit = async (e: FormEvent<HTMLFormElement>) => {
        ...
        if (!active) {
            setActive(true);
            gsap.to(button, {
                keyframes: getPlaneKeyframes(gsap.set, gsap.fromTo, button, setActive, setInput),
            });

            gsap.to(button, { keyframes: getTrailsKeyframes(button) });
        }

        // Post request to /api/addSuscription
    ...
    return (
        <div className="flex flex-col space-y-8 md:w-[400px]">
            <form className="newsletter-form mt-10 animate-fade-in-3" onSubmit={handleSubmit}>
                ...
                focus-within:bg-[#15141B] focus-within:!shadow-outline-gray-focus transition-all duration-300">
                    ...
                    <input
                        ...
                        placeholder-[#4B4C52] group-focus-within:placeholder-white bg-transparent placeholder:transition-colors
